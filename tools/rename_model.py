...
parser.add_argument("--checkpoint_path", default='../file/10002/models/model.ckpt-259000', help="restore ckpt") #原参数路径
parser.add_argument("--new_checkpoint_path", default='./', help="path_for_new ckpt") #新参数保存路径
parser.add_argument("--add_prefix", default='tower_0/', help="prefix for addition") #新参数名称中加入的前缀名
...
def main():
    ...
    with tf.Session() as sess:
        ...
        for var_name, _ in tf.contrib.framework.list_variables(args.checkpoint_path): #得到checkpoint文件中所有的参数（名字，形状）元组
            ...
            new_name = var_name
            if new_name == "Siamese/fc1/Variable":
        ...
        model_name = 'model.ckpt-259000' #构造一个保存的模型名称
